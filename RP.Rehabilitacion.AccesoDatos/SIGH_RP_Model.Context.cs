...
namespace RP.Rehabilitacion.AccesoDatos
{
    ...
    public partial class SIGH_RPEntities : DbContext
    {
        ...
        public DbSet<Agentes_Fisico> Agentes_Fisico { get; set; }
        public DbSet<Alta> Altas { get; set; }
        public DbSet<Cita> Citas { get; set; }
        public DbSet<Detalle_Plan_Servicio> Detalle_Plan_Servicio { get; set; }
        public DbSet<Detalle_Plan_Tratamiento> Detalle_Plan_Tratamiento { get; set; }
        ...
        public virtual ObjectResult<USP_BuscarPaciente_Result> USP_BuscarPaciente(Nullable<int> tipo_Documento_nIdTipoDocumento, string nNroDocumento)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_BuscarPaciente_Result>("USP_BuscarPaciente", tipo_Documento_nIdTipoDocumentoParameter, nNroDocumentoParameter);
        }
    
        public virtual ObjectResult<USP_ListarTiposDocumento_Result> USP_ListarTiposDocumento()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_ListarTiposDocumento_Result>("USP_ListarTiposDocumento");
        }
    }
}
